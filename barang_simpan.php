...
|| !$_POST['hrgtxt'] || !$_POST['brttxt'] || !$_POST['stocktxt']){
	echo "<script>alert('Data tidak boleh ada yang kosong !')</script>";	
	echo "<meta http-equiv='refresh' content='0;home.php?go=Barang_Form'>";		
}else {
	$sql = "INSERT INTO tblbarang(kode_barang,nama_barang,kode_kelompok,berat,harga_satuan,stock) VALUES ('$_POST[kdbarangtxt]','$_POST[nmbarangtxt]','$_POST[kelompoklst]','$_POST[brttxt]','$_POST[hrgtxt]','$_POST[stocktxt]')";
