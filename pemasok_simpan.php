...
if(!$_POST['kdpemasoktxt'] || !$_POST['nmpemasoktxt'] || !$_POST['almtxt']){
	...
	$sql = "INSERT INTO tblpemasok(kode_pemasok,nama_pemasok,nama_perusahaan,email,telepon,alamat) 
	VALUES ('$_POST[kdpemasoktxt]','$_POST[nmpemasoktxt]','$_POST[nmpertxt]','$_POST[emailtxt]','$_POST[tlpntxt]','$_POST[almtxt]')";
