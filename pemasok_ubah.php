...
$sql = "UPDATE tblpemasok set nama_pemasok = '$_POST[nmpemasoktxt]',nama_perusahaan = '$_POST[nmpertxt]',email = '$_POST[emailtxt]',telepon = '$_POST[tlpntxt]',alamat = '$_POST[almtxt]' where kode_pemasok = '$_POST[kdpemasoktxt]'";
