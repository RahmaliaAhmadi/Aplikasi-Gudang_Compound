...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Profile</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
	...
	<table class="table table-hover table-condensed table-striped" align="left">
                       <right> 
										    <a href="cetak/cetak_order.php" class="btn btn-primary"><i class='glyphicon glyphicon-print'></i> Print</a>
                          
                            <a href="home.php" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a></right>
                                <table width="800" border="0" align="center">
  <tr>
    <td rowspan="2" valign="center"><img src="Gambar/200.jpg" height="260" width="200"</td>
    <td valign="top" height="40"><h3>Profile Programer</h3></td>
    
  </tr>
  <tr>
    <td>Hello agan-agan semua ane mau berbagi buat agan semua yang masih newbie nih yang dapet tugas kuliah dibidang inventori menggunakan php 
    disini ane mau berbagi nih program aplikasi menggunakan PHP,CSS,HTML,JAVASCRIPT,JQUERY,AJAX,MYSQL dan menggnakan FRAMEWORK BOOTSTRAP mengikitu desain
    jaman kini. oke langsung adjh sedot ni aplikasi tapi kontak ane dulu lewat link sosmed dibawah gan. tenang adjh klo masalah biaya ane gk matok mahal cuma
    buat nongkrong secangkir kopi distarbucks biar kaya anak gahul. oy kenalin dulu gan biar akrab:
   
</br></br>
    Name   :Abriantama AD Infanteri
    </br></hr>
    Skills : PHP,CSS,HTML,JAVASCRIPT,JQUERY,AJAX,MYSQL
    </br></hr>
    Study  : D III MANAGEMENT INFOMATIKA, BSI
    </br></hr>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		 S1 SISTEM INFORMASI, NURI
             </br></hr>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;         S2 sedang lanjut gan doain biar lulusss
             </br>  </hr>
             
             </br>
             Sekian yaa gan ane lagi banyak kerjaan nih maklum programmer kan kulii kerja siang malem ketemu eror galau tingkat dewa.
             soory gan yang sering pantau web ane brynshare.web.id gk bisa ngakses coz banyak serangan jahat dan masalah kriris ekonomi hosting gan hehhe
             tapi tenang gan nanti ane cms blog. ok gan thanks salam programmer.
    </td>
  </tr>
  <tr>
    <td><?php
