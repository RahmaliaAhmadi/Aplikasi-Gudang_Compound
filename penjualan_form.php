...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Tambah Pengambilan Barang Penimbangan</h3>
...
<form id="form1" name="form1" method="post" action="home.php?go=Penjualan_Simpan">
  <table width="900" border="0" >
    <tr>
      ...
      <td width="11%" align="left" valign="middle">No Pengambilan</td>
      <td width="1%" align="left" valign="middle">:</td>
      <td width="24%" align="left" valign="top"><input name="nofakturtxt"  type="text" id="nofakturtxt" value="<?php echo "SSIPB-$tgl-$kode"?>" size="7" maxlength="50" readonly="readonly" /></td>
    </tr>
    <tr>
