...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Tambah Pembelian Barang </h3>
...
<script type="text/javascript">
	...
	function cari_barang_beli(){
		var kode=$("#kdbarangtxt").val();
			if(kode!=""){
				$.ajax({
					type:"post",
					url:"cari_barang_beli.php",
					data:"kode="+kode,
...
<?php
$sql = "select * from tbltransaksi_beli order by id desc";
...
<form id="form1" name="form1" method="post" action="home.php?go=Pembelian_Simpan">
  <table width="900" border="0"  >
    <tr>
      <td width="18%" align="left" valign="middle">Kode Barang</td>
      ...
      <td width="1%" align="left" valign="middle">:</td>
      <td width="24%" align="left" valign="top"><input name="nofakturtxt" type="text" id="nofakturtxt" value="<?php echo "FB-$tgl-$kode"?>" size="7" maxlength="50" readonly="readonly" /></td>
    </tr>
    <tr>
      ...
      size="6" maxlength="10" readonly="readonly" /></td>
    </tr>
    <tr>
      <td align="left" valign="middle">Harga Beli</td>
      <td align="left" valign="middle">:</td>
      <td align="left" valign="top"><input name="hrgtxt" type="text" id="hrgtxt" size="5" maxlength="15" readonly="readonly" /></td>
...
<?php
$no=1;
$nofaktur ="FB-$tgl-$kode";
$sql1 = "select * from tbltransaksi_beli_rinci inner join tblbarang on tbltransaksi_beli_rinci.kode_barang = tblbarang.kode_barang where tbltransaksi_beli_rinci.no_faktur ='$nofaktur'";
...
<?php
$sql_total = "select sum(sub_total) as gtotal from tbltransaksi_beli_rinci where tbltransaksi_beli_rinci.no_faktur ='$nofaktur'";
