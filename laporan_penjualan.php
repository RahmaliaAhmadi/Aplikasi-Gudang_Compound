...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Data Laporan Penjualan Barang</h3>
...
<a href="home.php?go=Laporan_Penjualan_Form" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a>
...
<form id="form1" name="form1" method="post" action="laporan_penjualan_cetak.php" target="new">
  <table width="700" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <th width="637" align="left" valign="middle" bgcolor="#8B9CC4" scope="col"><font color="#000000" face="Tahoma, Geneva, sans-serif" size="2"><b>DATA TRANSAKSI PENJUALAN PERIODE :
...
?>
 ...
 <?php
$sql_total = "select sum(total) as gtotal from tbltransaksi_jual where tanggal >='$tgl1' and tanggal <='$tgl2' order by id desc";
